...
public class Salcedo {
	 ...
	 Salcedo(){
		 ...
		 frame.getContentPane().setBackground(new Color(54, 69, 201));
			...
			txtJoseCrisostomo.setText("Anthony Salcedo");
			...
			txtFebruary.setText("September 14, 1993");
			...
			txtStrackeVia.setText("93/54 Shanahan Alley Apt. 183, Santo Tomas 1572 Masbate");
			...
			textField_4.setText("070-766-300");
